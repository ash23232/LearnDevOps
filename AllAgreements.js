var tableContent = "";
var pageName = "AllAgreements.aspx";
...
function loadTable(){
var requestUri = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/getbytitle('AgreementDetails')/items";
tableContent = "";
tableContents = "";
...
//Item ID
 var ItemID=objItems[i].ID;
                  ...
                  if(objItems[i].AgNumber != null && objItems[i].AgNumber != "" ){
	            		tableContent += '<td id='+ItemID+'><a href="http://nti-it-d-sp-01:5555/sites/purchase/ContractProcessing/SitePages/AgreementDetails.aspx?'+ItemID+'" target="_blank">' + objItems[i].AgNumber + '</a></td>';
	            	}else{
	            		tableContent += '<td id='+ItemID+'></td>';
	            	}
